      ...
      <div className={`w-full max-w-sm md:max-w-md p-6 sm:p-10 rounded-3xl shadow-2xl relative transition-all duration-300 border ${
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              type="email" name="email" placeholder="ejemplo@correo.com" value={formData.email} onChange={(e) => handleInputChange(e, setFormData)}
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="password" name="password" placeholder="••••••••" value={formData.password} onChange={(e) => handleInputChange(e, setFormData)}
              className={`w-full px-5 py-3.5 text-sm border rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${
                darkMode ? "bg-[#334155] border-slate-600 text-white placeholder-slate-500" : "bg-gray-50 border-gray-200 text-black"
              }`}
              required
          ...
          <button type="submit" disabled={isLoading} className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] sm:text-xs hover:bg-blue-700 transform transition-all active:scale-95 shadow-xl shadow-blue-900/20 mt-4 disabled:opacity-50">
